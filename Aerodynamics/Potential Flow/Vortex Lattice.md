Vortex lattice methods use discrete vortices to represent panels on a body. The finite vortices create a finite number of equations to solve and get the flow solution.
